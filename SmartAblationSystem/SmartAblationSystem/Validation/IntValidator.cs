...
namespace SmartAblationSystem.Views
{
    ...
    /// </summary>
    internal class IntValidator : ValidationRule
    {
        /// <summary>
        /// Gets a value indicating whether the Int Validation succeedeed or not
        /// . Safety classification: No injury or damage to health is possible (IEC 62304 Class A).
        /// </summary>
        ...
        public override ValidationResult Validate(object value, System.Globalization.CultureInfo cultureInfo)
        {
            ...
            if (value is String)
            {
                if (String.IsNullOrWhiteSpace((String)value) && int.TryParse((string)value, out intValue))
                {
