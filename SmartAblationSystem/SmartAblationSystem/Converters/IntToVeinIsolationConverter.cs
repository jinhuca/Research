...
{
    /// <summary>
    /// This class converts an integer to vein isolation duration value
    /// . Safety classification: No injury or damage to health is possible (IEC 62304 Class A).
    /// </summary>
    internal class IntToVeinIsolationConverter : IValueConverter
    {
        ...
        public object Convert(object value, Type targetType, object parameter, System.Globalization.CultureInfo culture)
        {
            ...
            if (parameter != null)
            {
                if (parameter.ToString() == "VeinIsolationDuration")
                {
                    duration = System.Convert.ToInt32(value);
