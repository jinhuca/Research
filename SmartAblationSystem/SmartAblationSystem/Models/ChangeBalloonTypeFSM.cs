...
namespace SmartAblationSystem.Models
{
    ...
    /// </summary>
    public class ChangeBalloonTypeFSM : INotifyPropertyChanged
    {
        ...
        public ChangeBalloonTypeFSM(InflateDeflateBalloonModel inflateDeflateBalloonModel)
        {
            InflateDeflateBalloonModel = inflateDeflateBalloonModel;
        }
        ...
        public bool DASBalloonEnabled
        {
            ...
            set
            {
                ...
                NotifyPropertyChanged("DASBalloonEnabled");
        ...
        public InflateDeflateBalloonModel InflateDeflateBalloonModel
        {
            get
            {
               return inflateDeflateBalloonModel;
            }
            set
            {
                inflateDeflateBalloonModel = value;
                NotifyPropertyChanged("InflateDeflateBalloonModel");
