...
/// <summary>
/// Manages the Advantech SBC CAN and IO
...
public class AdvCANIO
{
    ...
    ~AdvCANIO()
    {
        if (hDevice != INVALID_HANDLE_VALUE)
        {
            ...
            Thread.Sleep(100); // Do not change because the destruction takes at least 75ms
    ...
    *****************************************************************************/
    ...
    /// <summary>
    /// Opens CAN port by name
    ///. Safety classification: No injury or damage to health is possible (IEC 62304 Class A).
    /// </summary>
    /// <param name="CanPortName">port name</param>
    /// <param name="synchronization">true, synchronization ; false, asynchronous</param>
    /// <param name="MsgNumberOfReadBuffer">message number of read intptr</param>
    /// <param name="MsgNumberOfWriteBuffer">message number of write intptr</param>
    ...
    *****************************************************************************/
    ...
    /// <summary>
    /// Clears CAN port receive buffer
    ///. Safety classification: No injury or damage to health is possible (IEC 62304 Class A).
    /// </summary>
    /// <returns>=0 SUCCESS</returns>
    ...
    *****************************************************************************/
    ...
    /// Custom mode:
    ///       If baud rate value is user defined, driver will write the first 8
    ///       bits of low 16 bit in BTR0 of SJA1000.
    ///       The lower order 8 bits of low 16 bit will be written in BTR1 of SJA1000
    /// Standard mode
    ///. Safety classification: No injury or damage to health is possible (IEC 62304 Class A).
    /// </summary>
    /// <param name="BaudRateValue"></param>
    /// <returns> =0 SUCCESS</returns>
    ...
    *****************************************************************************/
    ...
    ///. Safety classification: No injury or damage to health is possible (IEC 62304 Class A).
    /// </summary>
    /// <param name="Btr0">BTR0 register value</param>
    /// <param name="Btr1">BTR1 register value</param>
    /// <returns>=0 SUCCESS</returns>
    ...
    *****************************************************************************/
    ...
    /// <summary>
    /// Sets timeout for read and write
    ///. Safety classification: No injury or damage to health is possible (IEC 62304 Class A).
    /// </summary>
    /// <param name="ReadTimeOutValue">ReadTimeOutValue - ms</param>
    /// <param name="WriteTimeOutValue">WriteTimeOutValue - ms</param>
    /// <returns>=0 SUCCESS</returns>
    ...
    *****************************************************************************/
    ...
    /// <summary>
    ///  Sets support for self reception
    ///. Safety classification: No injury or damage to health is possible (IEC 62304 Class A).
    /// </summary>
    /// <param name="SelfFlag">true, open self reception; false, close self reception</param>
    /// <returns>=0 SUCCESS</returns>
    ...
    *****************************************************************************/
    ...
    /// <summary>
    /// Sets listen only mode of the CAN Controller
    ///. Safety classification: No injury or damage to health is possible (IEC 62304 Class A).
    /// </summary>
    /// <param name="ListenOnly">true, open only listen mode; false, close only listen mode</param>
    ...
    *****************************************************************************/
    ...
    /// <summary>
    /// Sets acceptance filter mode of the CAN Controller
    ///. Safety classification: No injury or damage to health is possible (IEC 62304 Class A).
    /// </summary>
    /// <param name="FilterMode">PELICAN_SINGLE_FILTER, single filter mode; PELICAN_DUAL_FILTER, dule filter mode</param>
    /// <returns>=0 succeeded</returns>
    ...
    *****************************************************************************/
    ...
    /// <summary>
    /// Sets acceptance filter mask of the CAN Controller
    ///. Safety classification: No injury or damage to health is possible (IEC 62304 Class A).
    /// </summary>
    /// <param name="Mask">acceptance filter mask</param>
    /// <returns> =0 SUCCESS</returns>
    ...
    *****************************************************************************/
    ...
    /// <summary>
    ///  Sets acceptance filter code of the CAN Controller
    ///. Safety classification: No injury or damage to health is possible (IEC 62304 Class A).
    /// </summary>
    /// <param name="Code">acceptance filter code</param>
    /// <returns> =0 SUCCESS</returns>
    ...
    *****************************************************************************/
    ...
    /// <summary>
    /// Sets acceptance filter code and mask of the CAN Controller
    ///. Safety classification: No injury or damage to health is possible (IEC 62304 Class A).
    /// </summary>
    /// <param name="Mask">acceptance filter mask</param>
    /// <param name="Code">acceptance filter code</param>
    ...
    *****************************************************************************/
    ...
    /// <summary>
    /// Gets the current status of the driver and the CAN Controller
    ///. Safety classification: No injury or damage to health is possible (IEC 62304 Class A).
    /// </summary>
    ...
    *****************************************************************************/
    ...
    ///. Safety classification: No injury or damage to health is possible (IEC 62304 Class A).
    /// </summary>
    /// <param name="msgWrite">managed buffer for write</param>
    /// <param name="nWriteCount">msg number for write</param>
    /// <param name="pulNumberofWritten">real msgs have written</param>
    /// <returns>=0 SUCCESS</returns>
    ...
    *****************************************************************************/
    ...
    ///. Safety classification: No injury or damage to health is possible (IEC 62304 Class A).
    /// </summary>
    /// <param name="msgRead">managed buffer for read</param>
    /// <param name="nReadCount">msg number that unmanaged buffer can preserve</param>
    /// <param name="pulNumberofRead">real msgs have read</param>
    /// <returns>=0 SUCCESS</returns>
    ...
    *****************************************************************************/
    ...
    /// <summary>
    /// Executes ClearCommError of AdvCan
    ///. Safety classification: No injury or damage to health is possible (IEC 62304 Class A).
    /// </summary>
    /// <param name="ErrorCode">Error code if the CAN Controller occur error</param>
    ...
    *****************************************************************************/
    ...
    /// <summary>
    /// Executes SetCommMask of AdvCan
    ///. Safety classification: No injury or damage to health is possible (IEC 62304 Class A).
    /// </summary>
    /// <param name="EvtMask">event type</param>
    /// <returns>true SUCCESS</returns>
    ...
    *****************************************************************************/
    ...
    /// <summary>
    /// Executes GetCommMask of AdvCan
    ///. Safety classification: No injury or damage to health is possible (IEC 62304 Class A).
    /// </summary>
    /// <param name="EvtMask">event type</param>
    /// <returns>true SUCCESS</returns>
    ...
    *****************************************************************************/
    ...
    /// <summary>
    /// Returns wait CAN message or error of the CAN Controller
    ///. Safety classification: No injury or damage to health is possible (IEC 62304 Class A).
    /// </summary>
    /// <param name="msgRead">managed buffer for read</param>
    /// <param name="nReadCount">msg number that unmanaged buffer can preserve</param>
    /// <param name="pulNumberofRead">real msgs have read</param>
    /// <param name="ErrorCode">return error code when the CAN Controller has error</param>
    /// <returns>=0 SUCCESS</returns>
...
{
    /// <summary>
    /// Creates the Win32 Events class
    ///. Safety classification: No injury or damage to health is possible (IEC 62304 Class A).
    /// </summary>
    /// <param name="ol"></param>
    ...
    /// <summary>
    /// Destruct the Win32Events objects
    ///. Safety classification: No injury or damage to health is possible (IEC 62304 Class A).
    /// </summary>
    ~Win32Events()
    {
...
{
    /// <summary>
    /// Creates the Win32Ovrlap class
    ///. Safety classification: No injury or damage to health is possible (IEC 62304 Class A).
    /// </summary>
    /// <param name="evHandle">Pointer to event handler</param>
    ...
    /// <summary>
    /// Destruct the the Win32Ovrlap objects
    ///. Safety classification: No injury or damage to health is possible (IEC 62304 Class A).
    /// </summary>
    ~Win32Ovrlap()
    {
