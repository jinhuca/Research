...
namespace Module.Console.Helpers
{
  ...
  public class ASCIIToByteConverter
  {
    ...
    ///. Safety classification: No injury or damage to health is possible (IEC 62304 Class A).
    /// </summary>
    public Definitions.Board BoardType
    {
      get => boardType;
      set => boardType = value;
    }
    ...
    ///. Safety classification: No injury or damage to health is possible (IEC 62304 Class A).
    /// </summary>
    public int RS232DataArrayLength { get; set; }
