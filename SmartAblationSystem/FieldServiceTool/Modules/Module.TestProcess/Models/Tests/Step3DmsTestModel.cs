...
{
	public class Step3DmsTestModel : BindableBase, ITestModel
	{
		public Step3DmsTestModel(
			IDialogService dialogService,
			IUnityContainer unityContainer,
			ITestInfo testInfo,
			IDmsTestResult testResult,
			IMachineModel machineModel)
		{
			_dialogService = dialogService;
			_unityContainer = unityContainer;
			_info = testInfo;
			_info.Entity = TestEntity.DMSTestEntity;
			_result = testResult;
		...
		private IDmsTestResult _result;
		public IDmsTestResult Result
		{
			get => _result;
