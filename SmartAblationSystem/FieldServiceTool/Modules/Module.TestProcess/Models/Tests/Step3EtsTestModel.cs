...
{
	public class Step3EtsTestModel : BindableBase, ITestModel
	{
		public Step3EtsTestModel(
			IDialogService dialogService,
			IUnityContainer unityContainer,
			ITestInfo testInfo,
			IEtsTestResult testResult,
			IMachineModel machineModel)
		{
			_dialogService = dialogService;
			_unityContainer = unityContainer;
			_info = testInfo;
			_info.Entity = TestEntity.ETSTestEntity;
			_result = testResult;
		...
		private IEtsTestResult _result;
		public IEtsTestResult Result
		{
			get => _result;
