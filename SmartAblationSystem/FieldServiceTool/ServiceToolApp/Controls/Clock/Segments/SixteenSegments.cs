...
namespace ServiceToolApp.Controls.Clock.Segments
{
	public class SixteenSegments : SevenSegments
  {
    ...
    {
      VerticalSegmentDividerProperty.OverrideMetadata(
              typeof(SixteenSegments),
              new FrameworkPropertyMetadata(defVertDividerSixteen));


      HorizontalSegmentDividerProperty.OverrideMetadata(
          typeof(SixteenSegments),
    ...
    protected override void AssignSegments()
    {
      ...
      GeometryFigures.Add(new GeometryWithSegment(LeftTopHorizSegement(), Segments.LeftHorizontalTop));
      GeometryFigures.Add(new GeometryWithSegment(RightTopHorizSegement(), Segments.RightHorizontalTop));
      GeometryFigures.Add(new GeometryWithSegment(LeftBottomHorizSegement(), Segments.LeftHorizontalBottom));
      GeometryFigures.Add(new GeometryWithSegment(RightBottomHorizSegement(), Segments.RightHorizontalBottom));

      MiddleSegmPoints = GetMiddleSegmPoints();
      GeometryFigures.Add(new GeometryWithSegment(LeftMiddleSegement(), Segments.LeftMiddle));
      GeometryFigures.Add(new GeometryWithSegment(RightMiddleSegement(), Segments.RightMiddle));
      GeometryFigures.Add(new GeometryWithSegment(TopVerticalSegment(), Segments.TopVertical));
      GeometryFigures.Add(new GeometryWithSegment(BottomVerticalSegment(), Segments.BottomVertical));
      GeometryFigures.Add(new GeometryWithSegment(BottomLeftDiagSegment(), Segments.LeftBottomDiagonal));
      GeometryFigures.Add(new GeometryWithSegment(TopLeftDiagSegment(), Segments.LeftTopDiagonal));
      GeometryFigures.Add(new GeometryWithSegment(TopRightDiagSegment(), Segments.RightTopDiagonal));
      GeometryFigures.Add(new GeometryWithSegment(BottomRightDiagSegment(), Segments.RightBottomDiagonal));
