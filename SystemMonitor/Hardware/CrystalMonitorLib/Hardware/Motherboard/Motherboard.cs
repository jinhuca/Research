using CrystalMonitor.Hardware.Motherboard.Lpc;
using CrystalMonitor.Hardware.Motherboard.Lpc.EC;
using System;
using System.Collections.Generic;
using System.Linq;
using System.Text;
using OperatingSystem = CrystalMonitor.Software.OperatingSystem;

namespace CrystalMonitor.Hardware.Motherboard;
...
public class Motherboard : IHardware {
  ...
  /// <summary>
  /// Creates motherboard instance by retrieving information from <see cref="CrystalMonitor.Hardware.SMBios" /> and creates a new <see cref="SubHardware" /> based on data from <see cref="LpcIO" />
  /// and <see cref="EmbeddedController" />.
  /// </summary>
  /// <param name="smBios"><see cref="CrystalMonitor.Hardware.SMBios" /> table containing motherboard data.</param>
...
#pragma warning restore 67
  ...
  /// <summary>
  /// Gets the <see cref="CrystalMonitor.Hardware.Motherboard.Manufacturer" />.
  /// </summary>
  public Manufacturer Manufacturer { get; }

  /// <summary>
  /// Gets the <see cref="CrystalMonitor.Hardware.Motherboard.Model" />.
  /// </summary>
  public Model Model { get; }

  /// <summary>
  /// Gets the name obtained from <see cref="CrystalMonitor.Hardware.SMBios" />.
  /// </summary>
  public string Name {
  ...
  /// <summary>
  /// Gets the <see cref="CrystalMonitor.Hardware.SMBios" /> information.
  /// </summary>
