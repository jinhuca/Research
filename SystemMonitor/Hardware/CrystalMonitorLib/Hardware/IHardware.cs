...
public interface IHardware : IElement {
  /// <summary>
  /// <inheritdoc cref="CrystalMonitor.Hardware.HardwareType"/>
  /// </summary>
  ...
  /// <summary>
  /// Gets child devices, e.g. <see cref="CrystalMonitor.Hardware.Motherboard.Lpc.LpcIO"/> of the <see cref="CrystalMonitor.Hardware.Motherboard.Motherboard"/>.
  /// </summary>
