...
namespace Crystal.Strategies
{
  ...
  public abstract class BuilderStrategy
  {
    ...
    public virtual bool RequiredToBuildType(ICrystalContainer container, Type type, InternalRegistration registration, params InjectionMember[] injectionMembers)
    {
      return true;
    }
    ...
    /// <param name="registration">Reference to registration</param>
    /// <returns>Returns true if this strategy will participate in building of registered type</returns>
    public virtual bool RequiredToResolveInstance(ICrystalContainer container, InternalRegistration registration)
    {
      return false;
    }
