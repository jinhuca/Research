...
namespace Crystal.Lifetime
{
  ...
  public class LifetimeContainer : ILifetimeContainer
  {
    ...
    public LifetimeContainer(ICrystalContainer owner = null)
    {
      Container = owner;
    }

    /// <summary>
    /// The ICrystalContainer this container is associated with.
    /// </summary>
    /// <value>The <see cref="ICrystalContainer"/> object.</value>
    public ICrystalContainer Container { get; }
