...
namespace Crystal
{
  ...
  public partial class CrystalContainer
  {
...
#endif
      var set = generic == type ? GetNamedRegistrations((CrystalContainer)context.Container, type)
                                : GetNamedRegistrations((CrystalContainer)context.Container, type, generic);
    ...
    private static ResolveDelegate<BuilderContext> OptimizingFactory(ref BuilderContext context)
    {
      ...
      var chain = ((CrystalContainer)context.Container)._processorsChain;
