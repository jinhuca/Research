...
namespace Crystal.Storage
{
  ...
  public class QuickSet<TValue>
  {
    ...
    {
      var collisions = 0;
      var targetBucket = (hashCode & CrystalContainer.HashMask) % Buckets.Length;
      ...
      {
        Expand();
        targetBucket = (hashCode & CrystalContainer.HashMask) % Buckets.Length;
      }
    ...
    private void Expand()
    {
      ...
      {
        var hashCode = Entries[i].HashCode & CrystalContainer.HashMask;
