...
{
  /// <summary>
  /// Base class for all <see cref="ICrystalContainer"/> extension objects.
  /// </summary>
  public abstract class CrystalContainerExtension : ICrystalContainerExtensionConfigurator
  {
    private ICrystalContainer _container;
    ...
    /// </summary>
    /// <value>The <see cref="ICrystalContainer"/> that this extension has been added to.</value>
    public ICrystalContainer Container => _container;
