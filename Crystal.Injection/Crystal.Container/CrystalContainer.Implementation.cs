...
namespace Crystal
{
  ...
  public partial class CrystalContainer
  {
    ...
    // Container specific
    private readonly CrystalContainer _root;
    private readonly CrystalContainer _parent;
    internal readonly LifetimeContainer LifetimeContainer;
    private List<ICrystalContainerExtensionConfigurator> _extensions;
    ...
    // Strategies
    private StagedStrategyChain<BuilderStrategy, CrystalBuildStage> _strategies;
    ...
    /// <summary>
    /// Create a <see cref="CrystalContainer"/> with the given parent container.
    /// </summary>
    /// <param name="parent">The parent <see cref="CrystalContainer"/>. The current object
    /// will apply its own settings first, and then check the parent for additional ones.</param>
    private CrystalContainer(CrystalContainer parent)
    {
      // WithLifetime
    ...
    internal Action<CrystalContainer> SetDefaultPolicies = (CrystalContainer container) =>
    {
          // Default policies
    ...
    internal static void SetDiagnosticPolicies(CrystalContainer container)
    {
      // Default policies
      container.ContextExecutePlan = CrystalContainer.ContextValidatingExecutePlan;
      container.ContextResolvePlan = CrystalContainer.ContextValidatingResolvePlan;
    ...
    private class RegistrationContext : IPolicyList
    {
      ...
      internal RegistrationContext(CrystalContainer container, Type type, string name, InternalRegistration registration)
      {
