...
namespace Crystal.Processors
{
  public class ConstructorDiagnostic : ConstructorProcessor
  {
    ...
    const string CannotConstructDelegate = "The current type, {0}, is delegate and cannot be constructed. Crystal only supports resolving Func&lt;T&gt; and Func&lt;IEnumerable&lt;T&gt;&gt; by default.";
    ...
    public ConstructorDiagnostic(IPolicySet policySet, CrystalContainer container)
