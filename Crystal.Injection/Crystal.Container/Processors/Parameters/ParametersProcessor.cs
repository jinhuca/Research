...
namespace Crystal.Processors
{
  public abstract partial class ParametersProcessor<TMemberInfo> : MemberProcessor<TMemberInfo, object[]> where TMemberInfo : MethodBase
  {
    #region Fields

    protected readonly CrystalContainer Container;
    ...
    protected ParametersProcessor(IPolicySet policySet, Type attribute, CrystalContainer container)
