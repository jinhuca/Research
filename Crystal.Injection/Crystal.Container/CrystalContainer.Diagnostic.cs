...
namespace Crystal
{
  ...
  [DebuggerTypeProxy(typeof(CrystalContainerDebugProxy))]
  public partial class CrystalContainer
  {
    ...
    {
      return $"Resolution failed with error: {ex.Message}\n\nFor more detailed information run Crystal in debug mode: new CrystalContainer().AddExtension(new Diagnostic())";
    };
    ...
    internal class CrystalContainerDebugProxy
    {
      private readonly ICrystalContainer _container;

      public CrystalContainerDebugProxy(ICrystalContainer container)
      {
