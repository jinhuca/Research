...
namespace Crystal
{
  ...
  {
    /// <summary>
    /// Singleton lifetime creates globally unique singleton. Any Crystal container 
    ...
    /// <summary>
    /// Crystal returns the same instance each time the Resolve(...) method is called or when 
    ...
    /// <summary>
    /// Crystal returns a unique value for each child container.
    /// </summary>
    /// <remarks>
    /// <para>
    /// The Crystal container allows creating hierarchies of child containers. This lifetime 
    ...
    /// <summary>
    /// Crystal returns a unique value for each scope.
    /// </summary>
    /// <remarks>
    /// <para>
    /// The Crystal container allows creating hierarchies of child containers. This lifetime 
    ...
    /// </summary>
    /// <remarks>
    /// Transient lifetime is a default lifetime of the Crystal container. As the name implies it 
    /// lasts very short period of time, actually, no time at all. In the Crystal container terms, 
