...
namespace Crystal.Injection
{
  ...
  /// </summary>
  /// <remarks>This factory allow using predefined <code>Func&lt;ICrystalContainer, Type, string, object&gt;</code> to create types.</remarks>
  [Obsolete("InjectionFactory has been deprecated and will be removed in next release. Please use ICrystalContainer.RegisterFactory(...) method instead.", false)]
  public class InjectionFactory : InjectionMember
  {
    #region Fields

    private readonly Func<ICrystalContainer, Type, string, object> _factoryFunc;
    ...
    public InjectionFactory(Func<ICrystalContainer, object> factoryFunc)
    {
    ...
    /// </summary>
    /// <param name="factoryFunc">Factory function.</param>
    public InjectionFactory(Func<ICrystalContainer, Type, string, object> factoryFunc)
    {
