...
namespace Crystal
{
  ...
  /// through Registration enumeration. Each record is represented by an instance of this interface.
  /// </para>
  public interface IContainerRegistration
  {
    ...
    /// <remarks>
    /// <para>
    /// Each Crystal registration is assigned a lifetime manager that controls how 
    /// the container creates, manages, and disposes of created objects. Even if 
    /// manager is not assigned explicitly, Crystal will pick default type
