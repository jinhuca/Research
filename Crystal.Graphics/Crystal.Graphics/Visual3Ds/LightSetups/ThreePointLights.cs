namespace Crystal.Graphics
{
  ...
  public class ThreePointLights : LightSetup
  {
    ...
    {
      get => (double)GetValue(FillLightAngleProperty);

      set => SetValue(FillLightAngleProperty, value);
    }
    ...
    {
      get => (double)GetValue(FillLightSideAngleProperty);

      set => SetValue(FillLightSideAngleProperty, value);
    }
    ...
    {
      get => (Vector3D)GetValue(FrontDirectionProperty);

      set => SetValue(FrontDirectionProperty, value);
    }
    ...
    {
      get => (double)GetValue(KeyLightAngleProperty);

      set => SetValue(KeyLightAngleProperty, value);
    }
    ...
    {
      get => (double)GetValue(KeyLightBrightnessProperty);

      set => SetValue(KeyLightBrightnessProperty, value);
    }
    ...
    {
      get => (double)GetValue(KeyLightSideAngleProperty);

      set => SetValue(KeyLightSideAngleProperty, value);
    }
    ...
    {
      get => (double)GetValue(KeyToFillLightRatioProperty);

      set => SetValue(KeyToFillLightRatioProperty, value);
    }
    ...
    {
      get => (double)GetValue(KeyToRimLightRatioProperty);

      set => SetValue(KeyToRimLightRatioProperty, value);
    }
    ...
    {
      get => (double)GetValue(RimLightAngleProperty);

      set => SetValue(RimLightAngleProperty, value);
    }
    ...
    {
      get => (Point3D)GetValue(TargetProperty);
    ...
    {
      var up = UpDirection;
      var front = FrontDirection;
      up.Normalize();
      front.Normalize();
      var right = Vector3D.CrossProduct(UpDirection, FrontDirection);
      ...
      var tKey1 = new RotateTransform3D(new AxisAngleRotation3D(up, KeyLightSideAngle));
      var tKey2 = new RotateTransform3D(new AxisAngleRotation3D(right, KeyLightAngle));
      var keyLightDirection = front * Distance;
      keyLightDirection = tKey1.Transform(keyLightDirection);
      keyLightDirection = tKey2.Transform(keyLightDirection);
      var i = (byte)(255 * KeyLightBrightness);
      lightGroup.Children.Add(new PointLight(Color.FromRgb(i, i, i), Target - keyLightDirection));
      ...
      // specular highlights.)
      var tFill1 = new RotateTransform3D(new AxisAngleRotation3D(up, FillLightSideAngle));
      var tFill2 = new RotateTransform3D(new AxisAngleRotation3D(right, FillLightAngle));
      var fillLightDirection = front * Distance;
      fillLightDirection = tFill1.Transform(fillLightDirection);
      fillLightDirection = tFill2.Transform(fillLightDirection);
      var fi = (byte)Math.Round(i / KeyToFillLightRatio);
      lightGroup.Children.Add(new PointLight(Color.FromRgb(fi, fi, fi), Target - fillLightDirection));
      ...
      var tRim2 = new RotateTransform3D(new AxisAngleRotation3D(right, -RimLightAngle));
      var rimLightDirection = -front * Distance;
      rimLightDirection = tRim2.Transform(rimLightDirection);
      var ri = (byte)Math.Round(i / KeyToRimLightRatio);
      lightGroup.Children.Add(new PointLight(Color.FromRgb(ri, ri, ri), Target - rimLightDirection));
    }
