namespace Crystal.Graphics
{
  ...
  public class FileModelVisual3D : UIElement3D
  {
    ...
    {
      get => (Material)GetValue(DefaultMaterialProperty);
    ...
    {
      var importer = new ModelImporter { DefaultMaterial = DefaultMaterial };
      Visual3DModel = Source != null ? importer.Load(Source) : null;
      OnModelLoaded();
    }
  }
}