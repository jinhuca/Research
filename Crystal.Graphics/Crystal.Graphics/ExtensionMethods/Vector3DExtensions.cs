namespace Crystal.Graphics
{
  ...
  public static class Vector3DExtensions
  {
    ...
    /// </returns>
    public static bool IsUndefined(this Vector3D v) => double.IsNaN(v.X) && double.IsNaN(v.Y) && double.IsNaN(v.Z);
    ...
    /// A point.
    /// </returns>
    public static Point3D ToPoint3D(this Vector3D n) => new Point3D(n.X, n.Y, n.Z);
  }
}