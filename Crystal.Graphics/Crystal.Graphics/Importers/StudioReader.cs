  ...
  public class StudioReader : ModelReader
  {
    ...
    private void ReadTriangularMesh(BinaryReader reader, int chunkSize)
    {
      ...
      foreach(var fm in faceSets)
      {
        ...
        {
          mat = materials[fm.Name];
        }

        meshes.Add(new Mesh { Positions = positions, TriangleIndices = triangleIndices, TextureCoordinates = textureCoordinates, Material = mat, BackMaterial = mat });
      }
    }
    ...
    private class Mesh
    {
      ...
      public Model3D CreateModel()
      {
        ...
        return new GeometryModel3D(geometry, Material) { BackMaterial = BackMaterial };
      }
    }
