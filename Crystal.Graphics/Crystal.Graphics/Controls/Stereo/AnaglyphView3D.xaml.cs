...
namespace Crystal.Graphics
{
  ...
  public partial class AnaglyphView3D
  {
    ...
    public static readonly DependencyProperty HorizontalOffsetProperty = DependencyProperty.Register(
      nameof(HorizontalOffset), typeof(double), typeof(AnaglyphView3D), new UIPropertyMetadata(0.0, HorizontalOffsetChanged));
    ...
    public static readonly DependencyProperty MethodProperty = DependencyProperty.Register(
      nameof(Method), typeof(AnaglyphMethod), typeof(AnaglyphView3D), new UIPropertyMetadata(AnaglyphMethod.Gray));
    ...
    {
      get => (AnaglyphMethod)GetValue(MethodProperty);
