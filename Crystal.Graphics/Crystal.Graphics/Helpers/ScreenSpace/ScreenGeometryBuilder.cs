namespace Crystal.Graphics
{
  ...
  public abstract class ScreenGeometryBuilder
  {
    ...
    {
      var newTransform = visual.GetViewportTransform();
      ...
      if(newTransform == visualToScreen)
      {
        return false;
      }
      ...
      var newProjectionToScreen = viewport.GetProjectionMatrix() * viewport.GetViewportTransform();
      ...
      visualToScreen = newTransform;
      screenToVisual = newTransform.Inverse();
      projectionToScreen = newProjectionToScreen;
      visualToProjection = newVisualToProjection;
